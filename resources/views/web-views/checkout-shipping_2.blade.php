                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        ...
                                                        <span
                                                            style="color: red">*</span></label>
                                                    <input type="number" class="form-control" id="zip_value"
                                                           name="zip" {{$shipping_addresses->count()==0?'required':''}} value="{{session()->get('pincode')}}" disabled>
                                                </div>
                        ...
                        <form method="post" action="" id="billing-address-form">
                            ...
                            <div class="form-check"
                                ...
                                <input type="checkbox" id="same_as_shipping_address" onclick="hide_billingAddress()"
                                    name="same_as_shipping_address" class="form-check-input" checked {{$billing_input_by_customer==1?'':'checked'}}>
