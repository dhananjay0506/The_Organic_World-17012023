        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <!-- Shipping methods table-->
                    ...
                    <?php  $pincode = (session()->get('pincode')) ?>
                    @php($shipping_addresses=\App\Model\ShippingAddress::where('customer_id',auth('customer')->id())->where('is_billing',0)->where('zip', $pincode)->get()) 
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item mb-2 mt-2" onclick="anotherAddress()">
                                    ...
                                    <button type="button" class="btn btn-outline" data-toggle="collapse"
                                            data-target="#collapseThree">{{ \App\CPU\translate('Add')}} {{ \App\CPU\translate('address')}}
                                    </button>
                                    <div id="accordion">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="address_type">
                                                        <option
                                                            value="office">{{ \App\CPU\translate('Office')}}</option>
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        ...
                                                        <span
                                                            style="color: red">*</span></label>
                                                    <input type="number" class="form-control" value=""  id="zip_code"
                                                ...
                                                <div class="form-group mt-5">
                                                    ...
                                                    <div class="d-none" style="height: 200px;" id="location_map_canvas"></div>
                                                </div>
                        ...
                        <form method="post" action="" id="billing-address-form">
                            ...
                            <div class="form-check"
                                ...
                                <input type="checkbox" id="same_as_shipping_address" onclick="hide_billingAddress()"
                                    name="same_as_shipping_address" class="form-check-input" {{$billing_input_by_customer==1?'':'checked'}} checked>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        {{-- <input id="pac-input-billing" class="controls rounded"
                                                            ...
                                                            type="text"
                                                            placeholder="{{\App\CPU\translate('search_here')}}"/> --}}
                                                        <div class="d-none" style="height: 200px;" id="location_map_canvas_billing"></div>
                                                    </div>
                                                    <div class="form-check" style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 1.25rem;">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a class="btn bg-custome-warming btn-block" href="{{route('shop-cart')}}">
                                <i class="czi-arrow-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} mt-sm-0 mx-1 text-white"></i>
                                <span class="d-none d-sm-inline text-white">{{ \App\CPU\translate('shop_cart')}}</span>
                        ...
                        <div class="col-6">
                            <a class="btn btn-primary btn-block" href="javascript:" onclick="proceed_to_next()">
                                ...
                                <i class="czi-arrow-{{Session::get('direction') === "rtl" ? 'left' : 'right'}} mt-sm-0 mx-1 text-white"></i>
                            </a>
                        </div>
                    </div>
                    <!-- Sidebar-->
