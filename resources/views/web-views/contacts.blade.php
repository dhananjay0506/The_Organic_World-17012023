    ...
    <div class="container rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 for-send-message px-4 px-xl-5  box-shadow-sm">
                ...
                <h2 class="h4 mb-4 text-center"  style="color: #030303; font-weight:600;">{{\App\CPU\translate('send_us_a_message')}}</h2>
                <div class="row mb-2">
                    <div class="col-6">
                    <a class="text-dark" href="tel: {{$web_config['phone']->value}}">
                        <span ><i class="fa fa-phone m-2"></i>{{\App\CPU\Helpers::get_business_settings('company_phone')}} </span>
                    </a>
                    </div>
                    <div class="col-6">
                    <a class="text-dark" href="email:">
