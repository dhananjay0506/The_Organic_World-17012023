...
<aside class="col-lg-4 pt-4 pt-lg-0">
    ...
    <div class="cart_total">
     ...
     @if(isset($cart_shipping) && $cart_shipping->free_shipping_status == 1)
     ...
     @endif
        ...
        <div class="d-flex justify-content-between">
            ...
            <span class="cart_value total_shipping_cost_1">
                {{\App\CPU\Helpers::currency_converter($total_shipping_cost)}}
               <input type="hidden" value="{{\App\CPU\Helpers::currency_converter($total_shipping_cost)}}" class="total_shipping_cost">
        ...
        <div class="d-flex justify-content-between">
            ...
            <span class="cart_value">
                ...
                <input type="hidden" value="{{\App\CPU\Helpers::currency_converter($sub_total+$total_tax+$total_shipping_cost-$coupon_dis-$total_discount_on_product)}}" class="compare_price">
             </span>
        </div>
