...
<div class="border_product-single-hover" style="
background: #FFFFFF;
border: 1px solid #ABABAB;
border-radius: 20px;
">
    <div class=" inline_product clickable d-flex justify-content-center" 
        ...
        @endif
        <div class="d-flex d-block " style="cursor: pointer; width: 75%">
            ...
            <div class="details" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                ...
                {{-- <form id="add-to-cart-form1" class="mb-2"> --}}
                        ...
                        <div class="flex-start">
                            {{-- <div class="product-description-label mt-2 ">
                                ...
                                {{-- @foreach ($choice->options as $key => $option)
                                    ...
                                    @endforeach
                                    @else
                                    <select class="m-1" id="variant_{{$product->id}}" style="padding: 5px; border: 1px solid #dddbdb; border-radius: 8px; width: 100%; font-size: 14px;" onchange="varientprice1({{$product->id}},this.value,'','{{$choice->name}}')">
                    ...
                    <div class="d-flex mt-2 justify-content-around">
                        <div class="row ml-n3">
                        <div class="col-6">
                            <button class="btn bg-custome-warming text-white btn-sm" onclick="buy_now('dynamic-form',true,{{$product->id}})"
                                    type="button"
