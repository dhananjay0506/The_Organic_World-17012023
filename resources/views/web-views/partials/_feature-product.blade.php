...
<div class="product-single-hover" style="background: #FFFFFF;
border: 1px solid #ABABAB;
border-radius: 20px;">
    <div class="inline_product clickable d-flex justify-content-center" 
            style="cursor: pointer;max-height: 193px;min-height: 193px;background-position: center center;background-size: cover;">
        @if($product->discount > 0)
            <div class="d-flex" style="left:5px;top:30px;position: absolute">
                    <span class="for-discoutn-value p-1 pl-2 pr-2 bg-custome-brown">
    ...
    <div class="single-product-details" style="position:relative;height:145px;padding-top:10px; border-radius: 0px 0px 20px 20px;">
    ...
    <div class="text-center quick-view" >
        @if(Request::is('product/*'))
            <a class="btn btn-primary btn-sm bg-custome-brown text-white" href="{{route('product',$product->slug)}}">
                <i class="czi-forward align-middle {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}"></i>
                {{\App\CPU\translate('View')}}
            </a>
        @else
            <a class="btn btn-primary btn-sm bg-custome-brown text-white"
...
<div class=" border_product-single-hover" >
    <div class=" inline_product clickable d-flex justify-content-center" 
        ...
        <div class="d-flex d-block " style="cursor: pointer;">
            <a href="{{route('product',$product->slug)}}" style="text-align: -webkit-center;">
                <img src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                ...
                {{-- <form id="add-to-cart-form1" class="mb-2"> --}}
                        ...
                        <div class="flex-start">
                            {{-- <div class="product-description-label mt-2 ">
                                ...
                                {{-- @foreach ($choice->options as $key => $option)
                                    ...
                                    @endforeach
                                    @else
                                    <select class="m-1" id="variant_{{$product->id}}" style="padding: 5px; border: 1px solid #dddbdb; border-radius: 8px; width: 100%; font-size: 14px;" onchange="varientprice1({{$product->id}},this.value)">
                    ...
                    <div class="d-flex justify-content-between text-center">
                        ...
                        <span>
                            ...
                            <span class="text-accent ml-5" id="chosen_price_{{$product->id}}">
                                {{\App\CPU\Helpers::currency_converter(
                                    $product->unit_price-(\App\CPU\Helpers::get_product_discount($product,$product->unit_price))
                                )}}
                            </span>
                    ...
                    <div class="d-flex mt-2">
                        <div class="row ml-lg-n3">
                        <div class="col-lg-6 col-6">
                            <button class="btn bg-custome-warming btn-sm text-white" onclick="buy_now('dynamic-form',true,{{$product->id}})"
                                    type="button"
