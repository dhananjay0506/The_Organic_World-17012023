                        ...
                        @if ($digital_payment['status'] == 1)
                            ...
                            @if ($config == 1)
                                <div class="col-md-12 mb-4" style="cursor: pointer">
                                    ...
                                    @php($wltBalance = auth('customer')->user()->wallet_balance)
                            ...
                            @if (isset($inr) && isset($usd) && $config['status'])
                                <div class="col-md-6 mb-4 d-none" style="cursor: pointer" id="razorpay_payment">
                                    <div class="card">
                                        <div class="card-body" style="height: 100px">
                                            <form action="{!! route('payment-razor') !!}" method="POST" id="razorpay_payment_form">
                                                @csrf
                                            ...
                                            <form action="{!! route('payment-razor') !!}" method="POST" id="razorpay_payment_form_2">
                                                @csrf
                                                <!-- Note that the amount is in paise = 50 INR -->
                                                <!--amount need to be in paisa-->
                                                <input type="hiiden" name="user_phone" value="{{!empty(auth('customer')->user()->phone) ? auth('customer')->user()->phone : '' }}">
                                    ...
                                    <div class="card">
                                        <div class="card-body" style="height: 100px">
                                            <button class="btn btn-block click-if-alone" id="bKash_button"
                                                ...
                                                <img width="100"
                                                    src="{{ asset('public/assets/front-end/img/bkash.png') }}" />
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-body">
                <div class="form-row">
                    <div class="form-group col-12">
                        ...
                        <input class="form-control" type="text" value="{{\App\CPU\Helpers::currency_converter($wltBalance)}}" readonly>
                    </div>
                </div>
