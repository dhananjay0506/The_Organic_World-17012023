                    ...
                    <div class="mt-3" >
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex justify-content-between" style="width: 100%;padding: 14px;padding-top: 30px; ">
                                ...
                                <div style="width: 20%;background:#f9a61a;width:30px;height:35px;border-radius:3px; cursor: pointer;" onclick="searchByPrice()" class="d-flex justify-content-center align-items-center p-3">
                                ...
                                @foreach($categories as $category)
                                    <div >
                                        <div class="card-header p-1 flex-between">
                                            <div>
                                                <label class="for-hover-lable font-weight-bold" style="cursor: pointer"
...
@push('script')
    <script>
        ...
        function searchByPrice() {
            ...
            // console.log(min, max,  '{{url('/')}}/products');
            $.get({
                url: '{{url('/')}}/products',
                data: {
                    id: '{{$data['id']}}',
