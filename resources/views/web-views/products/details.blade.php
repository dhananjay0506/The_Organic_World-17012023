    ...
    <div class="container mt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
        ...
        <div class="row" style="direction: ltr">
                                                    ...
                                                    <div>
                                                        <li class="for-mobile-capacity">
                                                            ...
                                                            <label style="font-size: 12px;"
                                                                for="{{ $choice->name }}-{{ $option }}">{{ $option }}&nbsp;{{$product->unit}}</label>
                                                        </li>
                                                    </div>
                                                @endforeach
                                            </ul>
            ...
            <div class="col-md-3 ">
                ...
                @php($Shop_pincode = session()->get('pincode'))
                @php($more_product_from_seller = App\Model\Product::select('products.*','shop_pincodes.id as shop_pincodes_id','shop_pincodes.pincode')
                                                                    ->active()
                                                                    ->where('added_by',$product->added_by)->where('user_id',$product->user_id)
        ...
        <div class="row mt-4">
            ...
            @if (count($relatedProducts)>0)
                @foreach($relatedProducts as $key => $relatedProduct)
                    <div class="col-xl-3 col-sm-3 col-12" style="margin-bottom: 20px;">

                        {{-- 09-01-2023 comment for resolve prosess --}}
                        {{-- @include('web-views.partials._single-product',['product'=>$relatedProduct,'decimal_point_settings'=>$decimal_point_settings]) --}}
                            {{-- @include('web-views.partials._category-single-product',['product'=>$relatedProduct,'decimal_point_settings'=>$decimal_point_settings]) --}}
