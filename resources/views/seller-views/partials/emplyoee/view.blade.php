    ...
    <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs">
                <li class="nav-item">
                        <a class="nav-link active" href="{{ route('admin.sellers.view',$seller->id) }}">{{\App\CPU\translate('Store')}}/{{\App\CPU\translate('Warehouse')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-3">
                <div class="card">
                    <div class="card-header">
                        {{\App\CPU\translate('Pincode')}}
                    </div>
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <div class="flex-start">
                            <div><h5>{{\App\CPU\translate('Shops_pincode')}} : </h5></div>
                            @foreach($shop_pincode as $shop_pincodes)
                            <div class="mx-1"><h5>{{$shop_pincodes->pincode}}</h5></div><br>
                            @endforeach
                        </div>
                    </div>
                </div>
