...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row" id="printableArea">
            ...
            <div class="col-lg-4 {{$order->order_status == 'out_for_delivery'?'d-none':''}}">  {{-- if delivery is out of delivery the its hide--}}
                <div class="card mb-2">
                    ...
                    @if($order->customer)
                        ...
                        <div class="card-body"
                            ...
                            <div class="flex-start">
                                ...
                                <div class="mx-1"><a class="text-dark"
                                                     href="tel:{{$order->customer['phone']}}" id="customer_phone">{{$order->customer['phone']}}</a>
                                </div>
                            </div>
