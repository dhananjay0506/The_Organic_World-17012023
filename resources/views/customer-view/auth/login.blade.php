            ...
            <div class="col-md-6">
                <div class="card border-0 box-shadow">
                    <div class="card-body">
                        ...
                        <span style="font-size: 12px">{{\App\CPU\translate('If you are an existing customer of Mapletree farms, you will be happy to know that we have already migrated your account to Happy Harvest Farms. Please use your email id or phone number to login and click on "Forgot Password" to reset your password. In case you face any difficulties in accessing your existing account, please contact us on hello@happyharvestfarms.com.')}}</span>
                        <hr class="mt-2">
