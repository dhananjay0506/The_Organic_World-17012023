                ...
                <div class="navbar-vertical-content mt-2">
                    ...
                    <!--werehouse management -->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            {{-- <li class="nav-item {{(Request::is('admin/city*'))?'scroll-here':''}}">
                                <small class="nav-subtitle"
                                       title="">{{\App\CPU\translate('weare_house management')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li> --}}
                            <!-- Pages -->
                             {{-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/city*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.city.view')}}">
                                    ...
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('City Mangement')}}</span>
                                </a>
                            </li> --}}
                        @endif
                    <!--werehouse management ends-->
                    ...
                    <!--order management ends-->
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/category*') || Request::is('admin/sub*') || Request::is('admin/child*') ?'active':'')}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{(Request::is('admin/category*') ||Request::is('admin/sub*') ||  Request::is('admin/child*'))?'block':''}}">
                                    ...
                                    <li class="nav-item {{Request::is('admin/sub-sub-category/view')?'active':''}}">
                                     ...
                                     {{-- <li class="nav-item {{Request::is('admin/child-category/view')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.child-category.view')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{\App\CPU\translate('child_category')}}</span>
                                        </a>
                                    </li> --}}
                                </ul>
                            </li>
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/seller*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
                                    ...
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Ware')}}{{\App\CPU\translate('House')}}/{{\App\CPU\translate('Seller')}}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
