            ...
            <div class="navbar-vertical-footer-offset" style="padding-bottom: 0">
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @php($seller_parant_id = $seller->parent_id)
                                        ...
                                        <li class="nav-item {{Request::is('seller/pos/orders')?'active':''}}">
                                            <a class="nav-link " href="{{route('seller.pos.orders')}}" title="{{\App\CPU\translate('orders')}}">
                                                ...
                                                <span class="badge badge-info badge-pill ml-1">
                                                    ...
                                                    {{\App\Model\Order::where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where('order_type','POS')->where(['order_status'=>'delivered'])->count()}}
                                                </span>
                                            </span>
                                            </a>
                                        </li>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/all')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['all'])}}" title="">
                                        ...
                                        <span
                                            ...
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->count()}}
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/orders/list/pending')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['pending'])}}" title="">
                                        ...
                                        <span
                                            ...
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'pending'])->count()}}
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/orders/list/confirmed')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['confirmed'])}}" title="">
                                        ...
                                        <span
                                            class="badge badge-soft-info badge-pill {{Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'}}">
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'confirmed'])->count()}}
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/processing')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['processing'])}}" title="">
                                        ...
                                        <span
                                            ...
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'processing'])->count()}}
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/out_for_delivery')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['out_for_delivery'])}}"
                                       title="">
                                        ...
                                        <span
                                            class="badge badge-warning badge-pill {{Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'}}">
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'out_for_delivery'])->count()}}
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item {{Request::is('seller/orders/list/delivered')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['delivered'])}}" title="">
                                        ...
                                        <span
                                            ...
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'delivered'])->count()}}
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/orders/list/returned')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['returned'])}}" title="">
                                        ...
                                        <span
                                            ...
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'returned'])->count()}}
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/orders/list/failed')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['failed'])}}" title="">
                                        ...
                                        <span
                                            ...
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'failed'])->count()}}
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/orders/list/canceled')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.orders.list',['canceled'])}}" title="">
                                        ...
                                        <span
                                            class="badge badge-danger badge-pill {{Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'}}">
                                            {{ \App\Model\Order::where('order_type','default_type')->where(['seller_is'=>'seller'])->whereIn('seller_id',([$sellerId,$seller_parant_id]))->where(['order_status'=>'canceled'])->count()}}
                                        </span>
                                    </a>
                                </li>
                            </ul>
                                ...
                                <li class="nav-item {{Request::is('seller/product/stock-limit-list/in_house')?'active':''}}">
                                    <a class="nav-link " href="{{route('seller.product.stock-limit-list',['in_house', ''])}}">
                                        ...
                                        <span class="badge badge-soft-danger badge-pill ml-1">
                                            {{\App\Model\Product::where('added_by','seller')->whereIn('user_id',[auth('seller')->id(),auth('seller')->user()->parent_id])->where('request_status',1)->where('current_stock', '<', $stock_limit)->count()}}
                                        </span>
                                    </a>
                                </li>
                                          ...
                                          {{\App\CPU\translate('pending')}}
                                            <span class="badge badge-soft-danger badge-pill ml-1">
                                                {{\App\Model\RefundRequest::whereHas('order', function ($query) {
                                                    ...
                                                    ->whereIn('seller_id',([auth('seller')->id(),auth('seller')->user()->parent_id]));
                        ...
                        @php($Spi=\App\Model\Seller::where('id', auth('seller')->id())->first())
                        @if ($Spi->parent_id == 0)

                        <li class="nav-item {{(Request::is('seller/customer/list') ||Request::is('seller/sellers/subscriber-list')||Request::is('seller/sellers/seller-add') || Request::is('seller/sellers/seller-list'))?'scroll-here':''}}">
                            <small class="nav-subtitle" title="">{{\App\CPU\translate('user_section')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li class="navbar-vertical-aside-has-menu {{Request::is('seller/employee*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                               href="javascript:">
                                <i class="tio-users-switch nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Add')}} {{\App\CPU\translate('Employee')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{Request::is('seller/seller*')?'block':'none'}}">
                                <li class="nav-item {{Request::is('seller/employee-add')?'active':''}}">
                                    <a class="nav-link"
                                       href="{{route('seller.employee-add')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{\App\CPU\translate('add_new_emplyoee')}}
                                        </span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('seller/employee-list')?'active':''}}">
                                    <a class="nav-link"
                                       href="{{route('seller.employee-list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
