                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <label class="switch">
                                                    <input type="hidden" name="free_shipping_status"
                                                        class="free_shipping_status_value" value="0" />
                                                    <input type="checkbox" class="free_shipping_status"
                                                        id="free_shipping_status">
                                                    <span class="slider round"></span>
                                                </label>
                                                <label  for="free_shipping_status">{{ \App\CPU\translate('Free_shipping') }}</label>
                                           


                                            <div id="minimum_cart_value_div">
                                                <label
                                                    for="minimum_cart_value">{{ \App\CPU\translate('Minimum_cart_value') }}</label>
                                                <input type="number" min="0" max="1000000"
                                                    id="minimum_cart_value" name="minimum_cart_value"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
