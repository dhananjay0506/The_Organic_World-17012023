...
@section('title', \App\CPU\translate('Child Category'))
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ \App\CPU\translate('child_category_form')}}
                    </div>
                                    ...
                                    @foreach(json_decode($language) as $lang)
                                        <div
                                            ...
                                            <label class="input-label"
                                                   for="exampleFormControlInput1">{{\App\CPU\translate('Child_category')}} {{\App\CPU\translate('name')}}
                                                ({{strtoupper($lang)}})</label>
                                            <input type="text" name="name[]" class="form-control"
                                                   placeholder="{{\App\CPU\translate('New_Child_Category')}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>
                                    ...
                                    @else
                                        <div class="col-12">
                                            <div class="form-group lang_form" id="{{$default_lang}}-form">
                                                <label
                                                    class="input-label">{{\App\CPU\translate('Child_category')}} {{\App\CPU\translate('name')}}
                                                    ({{strtoupper($lang)}})</label>
                                                <input type="text" name="name[]" class="form-control"
                    ...
                    <div class="card-header">
                        ...
                        <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                            <div class="col-12 col-md-6">
                                <h5>{{ \App\CPU\translate('Child_category_table')}} <span style="color: red;">({{ $categories->total() }})</span></h5>
                            </div>
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{\App\CPU\translate('Search_by_Child_Category')}}" aria-label="Search orders" value="{{ $search }}" required>
                        ...
                        <div class="table-responsive">
                            <table style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{ \App\CPU\translate('child_category_name')}}</th>
        ...
        $('#cat_id').on('change', function () {
         ...
         $('#parent_id').on('change', function () {
            ...
            if (id) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{route('admin.child-category.getSubSubCategory')}}',
                    data: {
                        id: id
                    },
                    success: function (result) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        data: {id: id},
                        success: function () {
                            toastr.success('{{\App\CPU\translate('Child_Category_Deleted_Successfully')}}.');
                            location.reload();
                        }
                    });
                }
