...
@section('title', \App\CPU\translate('Sub_Category'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-group">
                                       ...
                                       <option value="{{$main_categories->id}}" @if($main_categories->id == $category->sc_id)? selected : '' @endif>{{$main_categories->name}}</option>
                                       @endforeach
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <center>
                                              <img style="width: 20%;border: 1px solid; border-radius: 10px;"
                                                     id="viewer"
                                                     src="{{asset('storage/app/public/sub_category')}}/{{$category['icon']}}"
                                                     alt=""/>
                                            </center>
                                        </div>
                                    </div>
