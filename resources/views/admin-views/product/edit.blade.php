                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select
                                            ...
                                            onchange="getRequest('{{url('/')}}/admin/product/get-categories?parent_id='+this.value,'child-category-select','select')">

                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="name">{{\App\CPU\translate('Child Category')}}</label>

                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            data-id="{{count($product_category)>=4?$product_category[3]->id:''}}"
                                            name="child_category_id" id="child-category-select">
    ...
    <script>
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                let child_category = $("#child-category-select").attr("data-id");
                ...
                getRequest('{{url('/')}}/admin/product/get-categories?parent_id=' + sub_sub_category + '&sub_category=' + child_category, 'child-category-select', 'select');
            }, 100)
