                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="js-example-basic-multiple form-control" name="sub_sub_category_id"
                                            id="sub-sub-category-select"  onchange="getRequest('{{ url('/') }}/admin/product/get-categories?parent_id='+this.value,'child-category-select','select')">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="js-example-basic-multiple form-control" name="child_category_id"
