                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body" style="padding: 20px">
                                ...
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Success')}}</label>
                                    <input type="color" name="success" value="{{ isset($data->success) ? $data->success : "" }}"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Info')}}</label>
                                    <input type="color" name="info" value="{{ isset($data->info) ? $data->info : "" }}"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Warning')}}</label>
                                    <input type="color" name="warning" value="{{ isset($data->warning) ? $data->warning : "" }}"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Danger')}}</label>
                                    <input type="color" name="danger" value="{{ isset($data->danger) ? $data->danger : "" }}"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Light')}}</label>
                                    <input type="color" name="light" value="{{ isset($data->light) ? $data->light : "" }}"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{\App\CPU\translate('Dark')}}</label>
                                    <input type="color" name="dark" value="{{ isset($data->dark) ? $data->dark : "" }}"
                                           class="form-control">
                                </div>
