...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            // 'code.digits_between'   => 'The code must be minimum 4 digits!',
    ...
    function list(Request $request, $type)
    {
        ...
        if ($type == 'in_house') {
            $pro = Product::select('products.*','shops.name as shop_name')
        ...
        $pro = $pro->orderBy('products.id', 'DESC')->paginate(Helpers::pagination_limit())->appends(['status' => $request['status']])->appends($query_param);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'discount'          =>'required|gt:-1',
            'shipping_cost'     => 'required|gt:-1',
            'code'              => 'required|min:1|unique:products,code,'.$product->id,
            'minimum_order_qty' => 'required|numeric|min:1',
        ], [
