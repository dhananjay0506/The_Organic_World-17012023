...
class SellerController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $sellers = Seller::where('parent_id', '=' , '0')->with(['orders', 'product'])
    ...
    public function view(Request $request, $id, $tab = null)
    {
        ...
        $shop_pincode = Seller::join('shops','shops.seller_id','sellers.id')
                        ->join('shop_pincodes','shop_pincodes.shop_id','shops.id')
        ...
        return view('admin-views.seller.view', compact('seller','shop_pincode'));
    }
    ...
    public function add_seller()
    {
        ...
        return view('admin-views.seller.add-new-seller',compact('cities','pincode'));
    }
}
