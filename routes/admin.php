...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'child-category', 'as' => 'child-category.','middleware'=>['module:product_management']], function () {
            Route::get('view', 'ChildCategoryController@index')->name('view');
            Route::get('fetch', 'ChildCategoryController@fetch')->name('fetch');
            Route::post('store', 'ChildCategoryController@store')->name('store');
            Route::post('edit', 'ChildCategoryController@edit')->name('edit');
            Route::post('update', 'ChildCategoryController@update')->name('update');
            Route::post('delete', 'ChildCategoryController@delete')->name('delete');
            Route::post('get-sub-category', 'ChildCategoryController@getSubCategory')->name('getSubCategory');
            Route::post('get-category-id', 'ChildCategoryController@getCategoryId')->name('getCategoryId');
            Route::post('get-sub-sub-category', 'ChildCategoryController@getSubSubCategory')->name('getSubSubCategory');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
          ...
          Route::group(['prefix' => 'city', 'as' => 'city.'], function () {
            ...
            Route::get('fetch', 'CityController@fetch')->name('fetch');
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
            ...
            Route::get('detail-export-order-data/{status}', 'OrderController@detail_bulk_export_data')->name('detail-order-bulk-export');
        });
