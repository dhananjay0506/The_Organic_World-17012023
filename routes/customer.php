...
//
Route::get('login_otp-verification', 'Customer\Auth\LoginController@otp_verification')->name('login_otp-verification');
Route::post('login_otp-verification', 'Customer\Auth\LoginController@login_otp_verification_submit')->name('login_otp_verification_submit');
