...
Route::group(['namespace' => 'Seller', 'prefix' => 'seller', 'as' => 'seller.'], function () {
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        // Route::group(['prefix' => 'employee', 'as' => 'employee.'], function () {
            Route::get('emplyoee-add', 'EmployeeController@add_emplyoee')->name('employee-add');
            Route::get('emplyoee-list', 'EmployeeController@index')->name('employee-list');
            // Route::get('order-list/{seller_id}', 'EmployeeController@order_list')->name('order-list');
            // Route::get('product-list/{seller_id}', 'EmployeeController@product_list')->name('product-list');
            Route::post('apply', 'EmployeeController@store')->name('apply');
        // });
    });
